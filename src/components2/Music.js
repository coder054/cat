...
class Music extends Component {
    ...
    componentDidMount = () => {
        axios.get('http://khoi.catopiana.com/wp-json/acf/v3/ms')
            .then(res => {
                console.log(res);
                this.setState({
                    quizs: res.data
    ...
    render() {
        ...
        return (
            <div className="one-question">
                <div className="q">
                    <img src={item.acf.question.img} alt="" />
                    <audio src={item.acf.question.sound}></audio>
                </div>
                <ul className="answer-list">
                    <li className="q">
                        <img onClick={this.handleClick.bind(this, 'answer_a')}  className={classNames({'checked': this.mobxstate.answer_a})} src={answer_a.imga} alt=""/>
                        <audio src={!!answer_a.sounda ? answer_a.sounda : null}></audio>
                    </li>
                    <li className="q">
                        <img  onClick={this.handleClick.bind(this, 'answer_b')}  className={classNames({'checked': this.mobxstate.answer_b})}  src={answer_b.imgb} alt=""/>
                        <audio src={!!answer_b.soundb ? answer_b.soundb : null}></audio>
                    </li>
                    <li className="q">
                        <img  onClick={this.handleClick.bind(this, 'answer_c')}  className={classNames({'checked': this.mobxstate.answer_c})}  src={answer_c.imgc} alt=""/>
                        <audio src={!!answer_c.soundc ? answer_c.soundc : null}></audio>
                    </li>
                    {!!answer_d.imgd && !!answer_d.soundd && (
                    <li className="q">
                        <img  onClick={this.handleClick.bind(this, 'answer_d')}  className={classNames({'checked': this.mobxstate.answer_d})}  src={answer_d.imgd} alt=""/>
                        <audio src={answer_d.soundd}></audio>
                    </li>
                    )}
                    {!!answer_e.imge && !!answer_f.soundf && (
                    <li className="q">
                        <img  onClick={this.handleClick.bind(this, 'answer_e')}  className={classNames({'checked': this.mobxstate.answer_e})}  src={answer_e.imge} alt=""/>
                        <audio src={answer_e.sounde}></audio>
                    </li>
                    )}
                    {!!answer_f.imgf && !!answer_f.soundf && (
                    <li className="q">
                        <img  onClick={this.handleClick.bind(this, 'answer_f')}   className={classNames({'checked': this.mobxstate.answer_f})}  src={answer_f.imgf} alt=""/>
                        <audio src={answer_f.soundf}></audio>
                    </li>
                    )}
                </ul>
                <p className="countTrue"> dap an dung: {this.mobxstate.dapandung} </p>
                <p className="countTrue">
                    Nguoi dung chon dung hay sai? { this.mobxstate.isUserChooseRight ?  ( '<span className="ra"></span>' ): ( '<span className="wa"></span>' ) }
                </p>
            </div>  
        )   // return
    }   // render
